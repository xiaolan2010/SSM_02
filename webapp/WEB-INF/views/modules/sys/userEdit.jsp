...
<body>
	<div class="container">
		<legend>编辑用户</legend>
		<form:form action="${APP_PATH}/sys/user/update" modelAttribute="user"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:textarea path="home" class="form-control" rows="3"
						placeholder="请输入地址"></form:textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">信息</label>
				<div class="col-sm-10">
					<form:textarea path="info" class="form-control" rows="3"
						placeholder="请输入信息"></form:textarea>
				</div>
			</div>
